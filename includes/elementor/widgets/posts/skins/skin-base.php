...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/zen_posts/section_query/after_section_end', [ $this, 'register_style_sections' ] );
	}
          ...
          <div class="zen-posts-filter">
                <ul class="zen-posts-filter__list">
                  <li class="zen-posts-filter__item">
                    <a class="zen-posts-filter__item-link zen-posts-filter__item-link_active" data-filter-key="all"  href="#">
                        All
                    </a>
                  </li>
                  ...
                  <?php
                    foreach ( $terms as $term ) { ?>
                      <li class="zen-posts-filter__item">
                        <a class="zen-posts-filter__item-link" data-filter-key="<?php echo $term->slug; ?>"  href="#">
                           <?php echo $term->name; ?>
                        </a>
                      </li>
                    <?php } ?>
